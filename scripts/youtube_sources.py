...
DEFAULT_YOUTUBE_ORACLE_SCRIPT_PATH = Path(r"C:\00_dev\_tmp\oracle\_livechat.sh")
COMPAT_YOUTUBE_ORACLE_SCRIPT_PATH = Path(r"C:\00_dev\_system\tmp\oracle_livechat.sh")
